								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="/addproduct/{{$list->id}}"><i class="fa fa-shopping-cart"></i></a>
											<a class="beta-btn primary" href="/productdetail/{{$list->id}}">Details <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
